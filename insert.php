...
//３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO gs_bm_table_sleep(id, checkDate, clinic, weight, bloodPressure, ahi, sleepiness, oralCleaning, jawJoint, oaUse, oralMuscle, tonguePressure, lowerJaw, nutrition, exercise, nextDate, remarks, indate )VALUES(NULL, :checkDate, :clinic, :weight, :bloodPressure, :ahi, :sleepiness, :oralCleaning, :jawJoint, :oaUse, :oralMuscle, :tonguePressure, :lowerJaw, :nutrition, :exercise, :nextDate, :remarks, sysdate())");
